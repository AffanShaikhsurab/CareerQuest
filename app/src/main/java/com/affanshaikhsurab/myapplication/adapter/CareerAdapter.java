...
public class CareerAdapter extends ArrayAdapter<Careers> {
    ...
    public CareerAdapter(Context applicationContext, int list, ArrayList<Careers> carrer) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listview == null){
            listview = LayoutInflater.from(getContext()).inflate(R.layout.career_list , parent , false);
